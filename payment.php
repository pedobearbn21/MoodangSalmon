...
?>
    ...
    <div>
      <div class="card-profile-stats">
        ...
        <div class="card-profile-stats-more" action='function.php'>
        <p><b>Course</b></p>
            <b><p>
            <?php 
            include_once('function.php');
              echo Showcourse($_SESSION['course'],$_SESSION['num']);
             ?>
            </p></b>
      <button type="submit" class="btn btn-secondary btn-lg btn-block" name='submit'>Add Course</button>
      <button type="submit" class="btn btn-secondary btn-lg btn-block" name='pay'>Payment</button>
      <button type="submit" class="btn btn-secondary btn-lg btn-block" name='delses'>Logout</button>
